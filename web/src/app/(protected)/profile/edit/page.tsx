  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
        <div>
          <Link href="/profile" className="text-sm text-gray-400 hover:text-blue-600 transition flex items-center gap-1 mb-1">
            ← Назад до профілю
          </Link>
          <h1 className="text-2xl font-bold text-gray-900">Редагування профілю</h1>
          <p className="text-sm text-gray-500 mt-0.5">Керуйте своїми особистими даними</p>
        </div>
      </div>
